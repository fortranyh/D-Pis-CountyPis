...
{
    public partial class Frm_yryb : DevComponents.DotNetBar.Office2007Form
    {
        public Frm_yryb()
        {
            InitializeComponent();
        ...
        private void Frm_yryb_Load(object sender, EventArgs e)
        {
            //高度自动适应
        ...
        private void RefreshData()
        {
            ...
            dt = ins.GetInfoYryb(sb.ToString());
        ...
        {
            Frm_hcgl_yryb ins = new Frm_hcgl_yryb();
            ins.BringToFront();
        ...
        private void superGridControl1_SelectionChanged(object sender, GridEventArgs e)
        {
            if (superGridControl1.PrimaryGrid.VirtualRowCount > 0)
            {
                ...
                textBox7.Text = Row.Cells["bz"].Value.ToString();
            }
        }
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            if (superGridControl1.PrimaryGrid.VirtualRowCount > 0)
            {
                ...
                DBHelper.BLL.hcgl ins = new DBHelper.BLL.hcgl();
                if (ins.UpdateInfoYryb(dtStart.Value.ToString("yyyy-MM-dd HH:mm:ss"), textBox5.Text.Trim(), textBox6.Text.Trim(), dateTimePicker1.Value.ToString("yyyy-MM-dd HH:mm:ss"), textBox1.Text.Trim(), textBox3.Text.Trim(), textBox2.Text.Trim(), textBox7.Text.Trim(), id) == 1)
                {
                    Frm_TJInfo("提示", "更新成功！");
                    RefreshData();
                }
