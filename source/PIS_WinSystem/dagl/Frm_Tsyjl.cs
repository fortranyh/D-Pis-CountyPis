...
{
    public partial class Frm_Tsyjl : DevComponents.DotNetBar.Office2007Form
    {
        public Frm_Tsyjl()
        {
            InitializeComponent();
        ...
        private void Frm_Tsyjl_Load(object sender, EventArgs e)
        {
            //高度自动适应
        ...
        private void RefreshData()
        {
            ...
            dt = ins.GetInfoTsyjl(sb.ToString());
        ...
        {
            Frm_hcgl_tsyjl ins = new Frm_hcgl_tsyjl();
            ins.BringToFront();
        ...
        private void superGridControl1_SelectionChanged(object sender, GridEventArgs e)
        {
            ...
            if (superGridControl1.PrimaryGrid.VirtualRowCount > 0)
            {
                ...
                Oldid = id;
                textBox1.Text = Row.Cells["wp"].Value.ToString();
                textBox3.Text = Row.Cells["jl"].Value.ToString();
                textBox2.Text = Row.Cells["qm"].Value.ToString();
                textBox4.Text = Row.Cells["bz"].Value.ToString();
                dtStart.Value = Convert.ToDateTime(Row.Cells["ghrq"].Value.ToString());
            }
        }
        //选中指定id的记录
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            if (superGridControl1.PrimaryGrid.VirtualRowCount > 0)
            {
                ...
                id = Row.Cells["id"].Value.ToString();
                DBHelper.BLL.hcgl ins = new DBHelper.BLL.hcgl();
                if (ins.UpdateInfoTsyjl(textBox1.Text.Trim(), textBox3.Text.Trim(), dtStart.Value.ToString("yyyy-MM-dd HH:mm:ss"), textBox2.Text.Trim(), textBox4.Text.Trim(), id) == 1)
                {
                    Frm_TJInfo("提示", "更新成功！");
                    RefreshData();
                }
