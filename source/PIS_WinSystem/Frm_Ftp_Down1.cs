...
namespace PIS_Sys
{
    public partial class Frm_Ftp_Down1 : DevComponents.DotNetBar.Office2007Form
    {
        public Frm_Ftp_Down1()
        {
            InitializeComponent();
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                //报告采集图多媒体资料下载
                dtMulit = insMulti.GetAllData(study_no, 4);
            ...
            if (!ImgQcFolder.Equals(""))
            {
                ...
                dtMulit = insMulti.GetAllData(study_no, 1);
                if (dtMulit != null && dtMulit.Rows.Count > 0)
                {
