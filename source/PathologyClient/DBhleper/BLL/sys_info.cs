...
namespace DBHelper.BLL
{
    ...
    public class sys_info
    {
        ...
        public DataTable GetThirdData(string hospital_code)
        {
            string sqlstr = "select hospital_code,hospital_name,pre_char,hospital_version,app_info,update_datetime from third_app_info where hospital_code='" + hospital_code + "'";
            ...
            {
                DBProcess.ShowException(ex, "GetThirdData 执行语句：" + sqlstr);
                dt = null;
            }
            return dt;
        }
