...
{
    public partial class Frm_Zzbl : DevComponents.DotNetBar.Office2007Form
    {
        public Frm_Zzbl()
        {
            InitializeComponent();
        ...
        private void Frm_Zzbl_Load(object sender, EventArgs e)
        {
            //
        ...
        public void tj_func(DataTable dt)
        {
            ...
            for (int i = 0; i < rows; i++)
            {
                ...
                if (i == rows - 1)
                {
                    ...
                    this.labelX1.Text = String.Format("统计值：共查询到 <font color='blue'><b>{0}</b></font> 条记录。及时报告数：<font color='blue'><b>{1}</b></font>,其他<font color='blue'><b>{2}</b></font>,组织病理诊断及时率<font color='blue'><b>{3}% </b></font>", rows, gfh_int, (rows - gfh_int), yxlstr);
                }
            }
        }
    }
