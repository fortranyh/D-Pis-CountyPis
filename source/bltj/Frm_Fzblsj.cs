...
{
    public partial class Frm_Fzblsj : DevComponents.DotNetBar.Office2007Form
    {
        public Frm_Fzblsj()
        {
            InitializeComponent();
        ...
        private void Frm_Fzblsj_Load(object sender, EventArgs e)
        {
            //高度自动适应
        ...
        private void RefreshData()
        {
            ...
            dt = ins.GetInfoFzblsj(sb.ToString());
        ...
        {
            Frm_Fzblsj_add ins = new Frm_Fzblsj_add();
            ins.BringToFront();
